...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<!-- jQuery library -->
	<script src="./Simulation_files/jquery.min.js.download"></script>
	<!-- Latest compiled JavaScript -->
	<script src="./Simulation_files/bootstrap.min.js.download"></script>
	<!-- Latest compiled and minified CSS -->
	<link rel="stylesheet" href="./Simulation_files/bootstrap.min.css">
	<link rel="stylesheet" href="./Simulation_files/jquery-ui.css">
	<script src="./Simulation_files/jquery-ui.js.download"></script>
	<script src="./Simulation_files/bootstrap-dialog.min.js.download"></script>
	<script src="./Simulation_files/simulation.js.download"></script>
	<link rel="stylesheet" href="./Simulation_files/custom.css">
</head>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					<li><a href="https://jeremyginnard.com/ProteinSimulations/index.php">Home</a></li>
					<li class="active"><a href="https://jeremyginnard.com/ProteinSimulations/simulation.php">Simulation<span class="sr-only">(current)</span></a></li>
					<li><a href="https://jeremyginnard.com/ProteinSimulations/queue.php">Queue</a></li>
					<li><a href="https://jeremyginnard.com/ProteinSimulations/results.php">Results</a></li>
				</ul>
			</div>
			<!-- /.navbar-collapse -->
		</div>
		...
		<div class="row">
			<div class="col-lg-6">
				<form action="submitSimulation.php" method="POST" onsubmit="sumbitSimulation();">
					...
					<input type="hidden" id="mutationList" name="mutationList">
					<input type="hidden" id="pdbFileName" name="pdbFileName">
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12 text-center">
				<p>Copyright © Programming Eagles 2017
				</p>
			</div>
		</div>
	</div>
